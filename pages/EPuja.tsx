...
import { Video, Globe, Laptop, Truck, Search, Star, ArrowRight, Sparkles, Wifi } from 'lucide-react';
...
const EPuja: React.FC = () => {
  ...
  return (
    <div className="bg-saffron-50 min-h-screen relative z-10 text-stone-800 overflow-hidden">
      ...
      {/* Decorative Background Elements (Light Spiritual Theme) */}
      ...
      <section className="py-24 bg-white relative z-10 clip-path-slant-top">
        ...
        <div className="container mx-auto px-4 relative">
            <div className="text-center mb-16">
                ...
                <h2 className="text-4xl font-serif font-bold text-stone-900 mb-6">{data.packagesTitle}</h2>
            ...
            {filteredPackages.length > 0 ? (
                ...
                >
                    <div className="bg-white rounded-3xl h-full p-8 flex flex-col relative overflow-hidden border border-stone-100 shadow-xl hover:shadow-2xl transition-all duration-300 hover:border-saffron-200">
                        ...
                        {pkg.sub && <p className="text-saffron-600 text-xs font-bold mb-4 tracking-wide uppercase bg-saffron-50 inline-block px-2 py-1 rounded w-fit">{pkg.sub}</p>}
